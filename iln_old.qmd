---
title: "I. Luminosidad Nocturna"
subtitle: "Procedimiento de Cálculo a Zona Urbana"
editor_options: 
...
Construir un indicador territorial que represente la luminosidad nocturna, cuya unidad mínima sea manzana urbana y entidad rural, a nivel país que se denominará "Indicador de Luminosidad Nocturna (ILN).
...
Se definirá una región de estudio, para el caso práctico de cálculo es la área urbana de las comunas de Valparaíso y Viña del Mar en la V Región, se le aplicará un buffer de 1000 metros y se cortará imagen tipo raster obtendida del producto satelital antes mecionado.
...
```{r echo=FALSE}
# ae <- saveRDS(ae, "data/rds/ae_valpo.rds")
ae <- readRDS("data/rds/ae_valpo.rds")
```
...
![](images/LN_raw.png){fig-align="center"}
...
```{r echo=FALSE}
mz_lum <-  readRDS("data/rds/luces_noc_gran_valpo.rds")
```
